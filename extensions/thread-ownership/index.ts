import type { OpenHearthConfig, OpenHearthPluginApi } from "openhearth/plugin-sdk";
...
function resolveOwnershipAgent(config: OpenHearthConfig): { id: string; name: string } {
