import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "openhearth/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "openhearth/plugin-sdk";
