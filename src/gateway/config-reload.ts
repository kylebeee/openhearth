...
import type { OpenHearthConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OpenHearthConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OpenHearthConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OpenHearthConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OpenHearthConfig) => void;
  log: {
