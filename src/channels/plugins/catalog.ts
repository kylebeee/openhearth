...
import type { OpenHearthPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverOpenHearthPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OpenHearthPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["OPENHEARTH_PLUGIN_CATALOG_PATHS", "OPENHEARTH_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OpenHearthPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OpenHearthPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OpenHearthPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOpenHearthPlugins({ workspaceDir: options.workspaceDir });
