...
export function listWhatsAppAuthDirs(cfg: OpenHearthConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenHearthConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenHearthConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenHearthConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenHearthConfig): ResolvedWhatsAppAccount[] {
