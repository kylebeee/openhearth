  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "openhearth-sbx-test",
        "--label",
        "openhearth.sandbox=1",
        "--label",
        "openhearth.sessionKey=main",
        "--label",
        "openhearth.createdAtMs=1700000000000",
        "--label",
        "openhearth.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
