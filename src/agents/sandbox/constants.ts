...
export const DEFAULT_SANDBOX_IMAGE = "openhearth-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openhearth-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openhearth-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openhearth-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openhearth-sbx-browser-";
