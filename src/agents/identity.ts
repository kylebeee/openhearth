import type { OpenHearthConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: OpenHearthConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: OpenHearthConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[openhearth]";
}
