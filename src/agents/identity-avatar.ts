...
function resolveAvatarSource(cfg: OpenHearthConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenHearthConfig, agentId: string): AgentAvatarResolution {
