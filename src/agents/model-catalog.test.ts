...
vi.mock("./models-config.js", () => ({
  ensureOpenHearthModelsJson: vi.fn().mockResolvedValue({ agentDir: "/tmp", wrote: false }),
}));

vi.mock("./agent-paths.js", () => ({
  resolveOpenHearthAgentDir: () => "/tmp/openhearth",
}));
...
describe("loadModelCatalog", () => {
  ...
  it("returns partial results on discovery errors", async () => {
    ...
    const result = await loadModelCatalog({ config: {} as OpenHearthConfig });
