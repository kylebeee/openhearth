...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenHearthAgentDir() returns mainAgentDir
    process.env.OPENHEARTH_STATE_DIR = tmpDir;
    process.env.OPENHEARTH_AGENT_DIR = mainAgentDir;
