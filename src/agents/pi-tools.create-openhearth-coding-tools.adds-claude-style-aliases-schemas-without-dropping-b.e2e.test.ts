...
describe("createOpenHearthCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenHearthCodingTools({
      config,
    ...
    const anthropicTools = createOpenHearthCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenHearthCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenHearthCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
