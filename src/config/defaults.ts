...
function resolveAnthropicDefaultAuthMode(cfg: OpenHearthConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyTalkApiKey(config: OpenHearthConfig): OpenHearthConfig {
...
export function applyModelDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyLoggingDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyContextPruningDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyCompactionDefaults(cfg: OpenHearthConfig): OpenHearthConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
