...
export function listSlackAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenHearthConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenHearthConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenHearthConfig): ResolvedSlackAccount[] {
