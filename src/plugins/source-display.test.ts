...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/openhearth/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhearth/extensions",
        global: "/Users/x/.openhearth/extensions",
        workspace: "/Users/x/ws/.openhearth/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.openhearth/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhearth/extensions",
        global: "/Users/x/.openhearth/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.openhearth/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openhearth/extensions",
        global: "/Users/x/.openhearth/extensions",
