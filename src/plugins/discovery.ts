...
import {
  ...
  type OpenHearthPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openhearth/voice-call -> voice-call).
...
export function discoverOpenHearthPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openhearth", "extensions")];
