...
const CORE_PACKAGE_NAMES = new Set(["openhearth"]);
...
export async function resolveOpenHearthPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveOpenHearthPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
