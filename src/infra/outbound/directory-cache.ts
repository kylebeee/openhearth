...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenHearthConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenHearthConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenHearthConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: OpenHearthConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: OpenHearthConfig): void {
