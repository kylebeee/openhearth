...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "openhearth-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenHearthPackageRoot } = await import("./openhearth-root.js");
    ...
    vi.mocked(resolveOpenHearthPackageRoot).mockResolvedValue("/opt/openhearth");
