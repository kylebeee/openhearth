...
export function listSignalAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenHearthConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenHearthConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenHearthConfig): ResolvedSignalAccount[] {
