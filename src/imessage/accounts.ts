...
export function listIMessageAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenHearthConfig): string {
...
export function listEnabledIMessageAccounts(cfg: OpenHearthConfig): ResolvedIMessageAccount[] {
