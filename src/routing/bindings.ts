...
export function listBindings(cfg: OpenHearthConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OpenHearthConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenHearthConfig) {
