...
function resolveDefaultAccountId(cfg: OpenHearthConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenHearthConfig): boolean {
...
export function summarizeBindings(cfg: OpenHearthConfig, bindings: AgentBinding[]): string[] {
