...
export function applyVercelAiGatewayProviderConfig(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenHearthConfig): OpenHearthConfig {
