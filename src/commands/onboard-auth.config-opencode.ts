...
export function applyOpencodeZenProviderConfig(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyOpencodeZenConfig(cfg: OpenHearthConfig): OpenHearthConfig {
