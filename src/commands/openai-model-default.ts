...
export function applyOpenAIProviderConfig(cfg: OpenHearthConfig): OpenHearthConfig {
...
export function applyOpenAIConfig(cfg: OpenHearthConfig): OpenHearthConfig {
