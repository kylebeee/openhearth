...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openhearth-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenHearthConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenHearthConfig["telegram"]>>,
