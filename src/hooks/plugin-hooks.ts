...
import type { OpenHearthPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenHearthPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenHearthPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
