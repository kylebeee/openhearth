...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.OPENHEARTH_STATE_DIR;
  const configPath = env.OPENHEARTH_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    OPENHEARTH_PROFILE: profile,
    OPENHEARTH_STATE_DIR: stateDir,
    OPENHEARTH_CONFIG_PATH: configPath,
    OPENHEARTH_GATEWAY_PORT: String(port),
    OPENHEARTH_GATEWAY_TOKEN: token,
    OPENHEARTH_LAUNCHD_LABEL: resolvedLaunchdLabel,
    OPENHEARTH_SYSTEMD_UNIT: systemdUnit,
    OPENHEARTH_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    OPENHEARTH_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    OPENHEARTH_STATE_DIR: stateDir,
    OPENHEARTH_CONFIG_PATH: configPath,
    OPENHEARTH_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    OPENHEARTH_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    OPENHEARTH_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    OPENHEARTH_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    OPENHEARTH_LOG_PREFIX: "node",
    OPENHEARTH_SERVICE_MARKER: NODE_SERVICE_MARKER,
    OPENHEARTH_SERVICE_KIND: NODE_SERVICE_KIND,
    OPENHEARTH_SERVICE_VERSION: VERSION,
  };
}
