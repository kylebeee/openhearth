...
export function isCommandEnabled(cfg: OpenHearthConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: OpenHearthConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as OpenHearthConfig),
...
export function getCommandDetection(_cfg?: OpenHearthConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: OpenHearthConfig) {
