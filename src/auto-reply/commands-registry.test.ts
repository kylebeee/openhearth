...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openhearth", { botUsername: "openhearth" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openhearth args", {
        botUsername: "openhearth",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openhearth: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openhearth" })).toBe(
      "/help@otherbot",
    );
  });
