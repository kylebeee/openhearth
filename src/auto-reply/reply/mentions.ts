...
function resolveMentionPatterns(cfg: OpenHearthConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenHearthConfig | undefined, agentId?: string): RegExp[] {
