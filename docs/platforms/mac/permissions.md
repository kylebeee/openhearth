...
- Same path: run the app from a fixed location (for OpenHearth, `dist/OpenHearth.app`).
...
Workaround: move files into the OpenHearth workspace (`~/.openhearth/workspace`) if you want to avoid per-folder grants.
