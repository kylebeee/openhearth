...
This guide summarizes a sane workflow for working on the pi integration in OpenHearth.
...
- Trigger the agent directly:
  - `pnpm openhearth agent --message "Hello" --thinking low`
...
State lives under the OpenHearth state directory. Default is `~/.openhearth`. If `OPENHEARTH_STATE_DIR` is set, use that directory instead.

To reset everything:

- `openhearth.json` for config
...
- [https://docs.openhearth.ai/testing](https://docs.openhearth.ai/testing)
- [https://docs.openhearth.ai/start/getting-started](https://docs.openhearth.ai/start/getting-started)
