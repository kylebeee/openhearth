---
summary: "First-run onboarding flow for OpenHearth (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenHearth">
...
<Step title="CLI">
  ...
  The app can install the global `openhearth` CLI via npm/pnpm so terminal
