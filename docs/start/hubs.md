---
summary: "Hubs that link to every OpenHearth doc"
read_when:
...
<Note>
If you are new to OpenHearth, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenHearth assistant](/start/openhearth)
