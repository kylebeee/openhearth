---
summary: "Overview of OpenHearth onboarding options and flows"
read_when:
...
OpenHearth supports multiple onboarding paths depending on where the Gateway runs
...
- [`openhearth onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenHearth app when you want a fully guided setup on macOS. Docs:
