...
read_when:
  - You are building a OpenHearth plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openhearth.plugin.json)

Every plugin **must** ship a `openhearth.plugin.json` file in the **plugin root**.
OpenHearth uses this manifest to validate configuration **without executing plugin
