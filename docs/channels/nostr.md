...
read_when:
  - You want OpenHearth to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OpenHearth to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`openhearth onboard`) and `openhearth channels add` list optional channel plugins.
...
```bash
openhearth plugins install @openhearth/nostr
```

Use a local checkout (dev workflows):

```bash
openhearth plugins install --link <path-to-openhearth>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "openhearth",
        "displayName": "OpenHearth",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "openhearth@example.com",
        "lud16": "openhearth@example.com"
      }
    }
  }
}
