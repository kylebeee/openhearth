...
- Install via CLI: `openhearth plugins install @openhearth/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openhearth plugins install ./extensions/zalo`
   - From npm (if published): `openhearth plugins install @openhearth/zalo`
...
- Approve via:
  - `openhearth pairing list zalo`
  - `openhearth pairing approve zalo <CODE>`
...
- Example: `openhearth message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openhearth channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openhearth logs --follow`
