...
本指南总结了在 OpenHearth 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenHearth 状态目录下。默认为 `~/.openhearth`。如果设置了 `OPENHEARTH_STATE_DIR`，则使用该目录。

要重置所有内容：

- `openhearth.json` 用于配置
...
- https://docs.openhearth.ai/testing
- https://docs.openhearth.ai/start/getting-started
