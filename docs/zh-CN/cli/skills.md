...
summary: "`openhearth skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- HearthHub 安装：[HearthHub](/tools/hearthub)

## 命令

```bash
openhearth skills list
openhearth skills list --eligible
openhearth skills info <name>
openhearth skills check
```
