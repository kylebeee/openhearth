...
- 生成的 Swift 模型：`apps/macos/Sources/OpenHearthProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/kylebeee/openhearth/main/dist/protocol.schema.json
