---
summary: "Use Qianfan's unified API to access many models in OpenHearth"
read_when:
...
3. OpenHearth installed on your system
...
4. Copy the API key for use with OpenHearth

## CLI setup

```bash
openhearth onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenHearth Configuration](/gateway/configuration)
