---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenHearth"
read_when:
  - You want Xiaomi MiMo models in OpenHearth
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenHearth uses
