---
summary: "Use Qwen OAuth (free tier) in OpenHearth"
read_when:
  - You want to use Qwen with OpenHearth
...
If you already logged in with the Qwen Code CLI, OpenHearth will sync credentials
