---
summary: "Use Synthetic's Anthropic-compatible API in OpenHearth"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenHearth registers it as the
...
Note: OpenHearth's Anthropic client appends `/v1` to the base URL, so use
