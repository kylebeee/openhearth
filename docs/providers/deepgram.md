...
Deepgram is a speech-to-text API. In OpenHearth it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, OpenHearth uploads the audio file to Deepgram and injects the transcript
