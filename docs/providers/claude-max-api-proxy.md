...
You can point OpenHearth at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenHearth
...
- [Anthropic provider](/providers/anthropic) - Native OpenHearth integration with Claude setup-token or API keys
