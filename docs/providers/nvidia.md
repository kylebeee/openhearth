---
summary: "Use NVIDIA's OpenAI-compatible API in OpenHearth"
read_when:
  - You want to use NVIDIA models in OpenHearth
...
openhearth onboard --auth-choice skip
openhearth models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
