...
```json5
{
  channels: {
    discord: {
      ...
      dm: { enabled: true, groupEnabled: false, groupChannels: ["openhearth-dm"] },
      guilds: {
        "123456789012345678": {
...
```json5
{
  hooks: {
    ...
    presets: ["gmail"],
    transformsDir: "~/.openhearth/hooks/transforms",
    mappings: [
      {
        match: { path: "gmail" },
        action: "agent",
...
- Serves agent-editable HTML/CSS/JS and A2UI over HTTP under the Gateway port:
  - `http://<gateway-host>:<gateway.port>/__openhearth__/canvas/`
  - `http://<gateway-host>:<gateway.port>/__openhearth__/a2ui/`
