...
OpenHearth has two separate “streaming” layers:
...
When block streaming is enabled, OpenHearth can **merge consecutive block chunks**
...
When draft streaming is active, OpenHearth disables block streaming for that reply to avoid double-streaming.
