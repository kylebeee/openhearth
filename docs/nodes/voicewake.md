...
OpenHearth treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.openhearth/settings/voicewake.json`

Shape:

```json
{ "triggers": ["openhearth", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
