...
show_usage() {
    cat << EOF
clawlog - OpenHearth Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenHearth logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenHearth logs flow through the macOS unified log (subsystem: ai.openhearth).
