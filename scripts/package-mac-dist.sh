...
# Output:
# - dist/OpenHearth.app
# - dist/OpenHearth-<version>.zip
# - dist/OpenHearth-<version>.dmg
...
APP="$ROOT_DIR/dist/OpenHearth.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenHearth-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenHearth-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenHearth-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenHearth-$VERSION.dSYM.zip"
