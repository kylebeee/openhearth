...
FEED_URL=${2:-"https://raw.githubusercontent.com/openhearth/openhearth/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/openhearth/openhearth/releases/download/v${VERSION}/"}
