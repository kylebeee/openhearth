...
#
# Installation:
#   mkdir -p ~/.clawdock && curl -sL https://raw.githubusercontent.com/openhearth/openhearth/main/scripts/shell-helpers/clawdock-helpers.sh -o ~/.clawdock/clawdock-helpers.sh
...
_clawdock_ensure_dir() {
  ...
  if [[ -n "$found_path" ]]; then
    ...
    echo "Clone it first:"
    echo ""
    echo "  git clone https://github.com/openhearth/openhearth.git ~/openhearth"
