...
docker run --rm -t \
  ...
  -e OPENHEARTH_LIVE_GATEWAY_MODELS="${OPENHEARTH_LIVE_GATEWAY_MODELS:-${CLAWDBOT_LIVE_GATEWAY_MODELS:-all}}" \
  -e OPENHEARTH_LIVE_GATEWAY_PROVIDERS="${OPENHEARTH_LIVE_GATEWAY_PROVIDERS:-${CLAWDBOT_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e OPENHEARTH_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${OPENHEARTH_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
